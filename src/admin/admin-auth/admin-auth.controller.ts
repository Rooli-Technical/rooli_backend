...
import {
  ...
  ApiBearerAuth, ApiBody, ApiProperty,
} from '@nestjs/swagger';
...
export class AdminAuthController {
  ...
  // @ApiResponse({ status: 201, type: AdminLoginResponseDto, description: 'Login successful.' })
  // @ApiResponse({ status: 401, description: 'Invalid credentials.' })
  // @ApiResponse({ status: 403, description: 'Not a SUPER_ADMIN account or account is locked.' })
