...
export class ManualOverrideDto {
  @ApiProperty({
    example: 'clxyz123abc',
    description:
      'ID of the organization whose subscription will be overridden.',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @IsNotEmpty({
    message: 'customEndDate is required for custom_end_date override',
  })
  @IsDateString()
...
export class PlanResponseDto {
  ...
  @ApiProperty({
    example: '29000.00',
    description: 'NGN price as Decimal string.',
  })
  priceNgn: string;
...
export class TransactionResponseDto {
  ...
  @ApiProperty({
    example: 'Rocket',
    description: 'Plan name from active subscription.',
  })
  planName: string;
